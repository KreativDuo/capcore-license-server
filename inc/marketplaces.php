...
class Envato {
   ...
   /**
    * Retrieve the value of API KEY, if needed.
    *
   ...
   */
   public function display_thumbs($user_name, $marketplace_name, $limit = null) {
      ...
      <li>
          <a href="<?php echo $item->url . ""; ?>" title="<?php echo $item->item;?>">   
   ...
   */
   public function apply_limit( $orig_arr, $limit ) {
        ...
        $limit = $limit > count( $orig_arr ) ? count($orig_arr) : $limit;
   ...
   */
    ...
    */
    protected function has_expired( $cache_path, $expires = NULL )  {
        ...
        $expires = !isset( $expires ) ? $this->cache_expires : $expires;
